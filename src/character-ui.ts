import type { Explanation, Projection, Reference } from "./character-model.js";
...
export function rule(name: string, reference?: Reference, explanation?: Explanation, summary?: string, projection?: Projection): HTMLElement {
